...
namespace QuanLyKhachSan
{
    public partial class fInformation : Form
    {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            if(AccountDAO.Instance.changeInforAccountAdmin(User.Instance.UserName, disPlayname, newPassword))
            {
                MessageBox.Show("Thay đổi thông tin admin thành công");
                User.Instance.Create("Admin", tb_NewPassword.Text);
                pn_Password.Hide();
                pn_NewPassword.Hide();
                pn_ReNewPassword.Hide();
                tb_PassWord.Text = "";
